...
if (process.env.REDISTOGO_URL) {
	...
	var redisClient = require('redis-url').createClient(process.env.REDISTOGO_URL); //newRedisClient(process.env.REDISTOGO_URL);
	var pubSubClient = require('redis-url').createClient(process.env.REDISTOGO_URL); //newRedisClient(process.env.REDISTOGO_URL);
} else {
	var redisClient = redis.createClient(settings.REDIS_PORT, settings.REDIS_HOST);
	var pubSubClient = redis.createClient(settings.REDIS_PORT, settings.REDIS_HOST);
}
